$.extend(!0, $.fn.dataTable.defaults, {sDom: "<'row'<'col-xs-9'l><'col-xs-3'f>r>t<'row'<'col-xs-9'i><'col-xs-3'p>>", oLanguage: {sLengthMenu: "Mostrando _MENU_ registros"}}), $.extend($.fn.dataTableExt.oStdClasses, {sWrapper: "dataTables_wrapper form-inline", sFilterInput: "form-control input-sm", sLengthSelect: "form-control input-sm"}), $.fn.dataTable.Api ? ($.fn.dataTable.defaults.renderer = "bootstrap", $.fn.dataTable.ext.renderer.pageButton.bootstrap = function (a, b, c, d, e, f) {
